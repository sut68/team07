    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ width: 4, height: 24, background: THEME_RED, borderRadius: 2 }}
            />
            <h1
              style={{
                fontSize: 20,
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", background: "#f5f7fa" }}>
        ...
        <div style={{ flex: 1, padding: "20px 24px", overflowY: "auto", display: "flex", flexDirection: "column" }}>
          {locked ? (
            ...
            <div style={{ margin: "auto", textAlign: "center", color: "#9ca3af" }}>
              <Empty
                description="เลือกหัวข้อทางซ้ายเพื่อเริ่มแชท"
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, width: "100%" }}>
            ...
            <Button
              ...
              style={{
                background:
                  locked || !roomJoined || (!message.trim() && !selectedFile) ? undefined : THEME_RED,
                borderColor:
                  locked || !roomJoined || (!message.trim() && !selectedFile) ? undefined : THEME_RED,
                minWidth: 40,
              }}
