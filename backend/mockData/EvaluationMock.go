...
var MockCriteria = []entity.Criteria{
	...
	// 4.4 Individual (5 Scores -> 5 Topics x 1 Score)
	{
		Name:         "Technical Understanding (ความเข้าใจเชิงเทคนิค)",
		MaxScore:     1,
		Order:        7,
		EvaluationID: 4,
		IsGroup:      false,
		CriteriaLevel: []entity.CriteriaLevel{
			{Description: "Deep Understanding (เข้าใจลึกซึ้ง)", Score: 1.0},
			{Description: "Good Understanding (เข้าใจดี)", Score: 0.8},
			{Description: "Basic Understanding (เข้าใจพื้นฐาน)", Score: 0.6},
			{Description: "Low Understanding (เข้าใจน้อย)", Score: 0.4},
			{Description: "No Understanding (ไม่เข้าใจ)", Score: 0.0},
		},
	},
	{
		Name:         "Individual Q&A (การตอบคำถามรายบุคคล)",
		MaxScore:     1,
		Order:        8,
		EvaluationID: 4,
		IsGroup:      false,
		CriteriaLevel: []entity.CriteriaLevel{
			{Description: "Precise & Clear (ชัดเจน)", Score: 1.0},
			{Description: "Good (ดี)", Score: 0.8},
			{Description: "Acceptable (พอใช้)", Score: 0.6},
			{Description: "Vague (กำกวม)", Score: 0.4},
			{Description: "Cannot Answer (ตอบไม่ได้)", Score: 0.0},
		},
	},
	{
		Name:         "Responsibility & Contribution (ความรับผิดชอบ)",
		MaxScore:     1,
		Order:        9,
		EvaluationID: 4,
		IsGroup:      false,
		CriteriaLevel: []entity.CriteriaLevel{
			{Description: "High Contribution (มีส่วนร่วมสูง)", Score: 1.0},
			{Description: "Good Contribution (มีส่วนร่วมดี)", Score: 0.8},
			{Description: "Average (ปานกลาง)", Score: 0.6},
			{Description: "Low (น้อย)", Score: 0.4},
			{Description: "None (ไม่มี)", Score: 0.0},
		},
	},
	{
		Name:         "Professionalism (ความเป็นมืออาชีพ)",
		MaxScore:     1,
		Order:        10,
		EvaluationID: 4,
		IsGroup:      false,
		CriteriaLevel: []entity.CriteriaLevel{
			{Description: "Excellent (ดีเยี่ยม)", Score: 1.0},
			{Description: "Good (ดี)", Score: 0.8},
			{Description: "Fair (พอใช้)", Score: 0.6},
			{Description: "Poor (แย่)", Score: 0.4},
		},
	},
	{
		Name:         "Problem Solving (การแก้ปัญหา)",
		...
		IsGroup:      false,
		CriteriaLevel: []entity.CriteriaLevel{
			{Description: "Effective (มีประสิทธิภาพ)", Score: 1.0},
			{Description: "Good (ดี)", Score: 0.8},
			{Description: "Average (ปานกลาง)", Score: 0.6},
			{Description: "Weak (อ่อน)", Score: 0.4},
		},
	},
}
