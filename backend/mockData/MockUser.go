...
var MockUser = []entity.User{
	...
	{Username: "B6400001@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example1", Lastname: "ex1", Email: "example1@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400002@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example2", Lastname: "ex2", Email: "example2@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400003@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example3", Lastname: "ex3", Email: "example3@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400004@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example4", Lastname: "ex4", Email: "example4@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400005@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example5", Lastname: "ex5", Email: "example5@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400006@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example6", Lastname: "ex6", Email: "example6@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400007@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example7", Lastname: "ex7", Email: "example7@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400008@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example8", Lastname: "ex8", Email: "example8@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400009@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example9", Lastname: "ex9", Email: "example9@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400010@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example10", Lastname: "ex10", Email: "example10@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400011@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example11", Lastname: "ex11", Email: "example11@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},
	{Username: "B6400012@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "example12", Lastname: "ex12", Email: "example12@gmail.com", Phone: "0884212030", Pass: &passTrue, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 2},

	{Username: "B6500001@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "Rattasat", Lastname: "Thongsangiam", Email: "rattasat7742@gmail.com", Phone: "0624987765", Pass: &passFalse, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 1},
	{Username: "B6500002@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "Thanathon", Lastname: "Hodon", Email: "s23372@suratham.ac.th", Phone: "0962934415", Pass: &passFalse, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 1},
	{Username: "B6500003@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "Pitsinee", Lastname: "Teemuaengsai", Email: "Student3@gmail.com", Phone: "0933456789", Pass: &passFalse, GenderID: 2, BranchID: 1, RoleID: 3, StatusID: 1},
	{Username: "B6500004@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "Kiattisak", Lastname: "Pattanee", Email: "Student4@gmail.com", Phone: "0944567890", Pass: &passFalse, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 1},
	{Username: "B6500005@sut.ac.th", Password: jwtService.HashPassword("std123"), Firstname: "Thammarat", Lastname: "Songviwat", Email: "Student5@gmail.com", Phone: "0955678901", Pass: &passFalse, GenderID: 1, BranchID: 1, RoleID: 3, StatusID: 1},
