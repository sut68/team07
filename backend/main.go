...
func main() {
	...
	r.GET("/getProcess" , progress.GetProGressByID)
	r.POST("/assignProgress" , progress.AssignProGress)
	r.POST("/modifyProgress" , progress.UpdateProGress)
	r.DELETE("/deleteProgress" , progress.DeleteProgress)
